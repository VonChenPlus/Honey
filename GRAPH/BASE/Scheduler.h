...
namespace GRAPH
{
    ...
    protected:
        ...
        Scheduler* _scheduler; // weak HObject
        float _elapsed;
        bool _runForever;
        bool _useDelay;
    ...
    public:
        ...
        bool initWithSelector(Scheduler* scheduler, SEL_SCHEDULE selector, HObject* target, float seconds, unsigned int repeat, float delay);
    ...
    public:
        ...
        */
        ...
        /** The scheduled method will be called every `interval` seconds.
         ...
         @since v3.0
         */
        void schedule(SEL_SCHEDULE selector, HObject *target, float interval, unsigned int repeat, float delay, bool paused);
        ...
        /** The scheduled method will be called every `interval` seconds for ever.
         ...
         @param paused Whether or not to pause the schedule.
         */
        void schedule(SEL_SCHEDULE selector, HObject *target, float interval, bool paused);
        ...
        /** Unschedules a selector for a given target.
         ...
         @since v3.0
         */
        void unschedule(SEL_SCHEDULE selector, HObject *target);
        ...
        /** Checks whether a selector for a given taget is scheduled.
         ...
         @since v3.0
         */
        bool isScheduled(SEL_SCHEDULE selector, HObject *target);
