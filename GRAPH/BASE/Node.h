...
namespace GRAPH
{
    ...
    * @brief Node is the base element of the Scene Graph. Elements of the Scene Graph must be Node objects or subclasses of it.
    ...
    public:
         ...
         *
         * Usually we use `MATH::Vector2f(x,y)` to compose MATH::Vector2f object.
        ...
        /** Sets the position (x,y) using values between 0 and 1.
         ...
         @code
         // pseudo code
         void setNormalizedPosition(MATH::Vector2f pos) {
         ...
         * Sets the position (x,y) of the node in its parent's coordinate system.
         *
         * Passing two numbers (x,y) is much efficient than passing MATH::Vector2f object.
         * This method is bound to Lua and JavaScript.
         * Passing a number is 10 times faster than passing a object from Lua to c++.
         *
         @code
         // sample code in Lua
         local pos  = node::getPosition()  -- returns MATH::Vector2f object from C++.
        ...
        /**
         * Gets position in a more efficient way, returns two number instead of a MATH::Vector2f object.
         *
         ...
         *
         * @see `setAnchorPoint(const MATH::Vector2f&)`
         *
        ...
        */
        ...
        /**
         * Converts a MATH::Vector2f to node (local) space coordinates. The result is in Points.
         *
        ...
        /**
         * Converts a MATH::Vector2f to world space coordinates. The result is in Points.
         *
        ...
        /**
         * Converts a local MATH::Vector2f to world space coordinates.The result is in Points.
         * treating the returned/received node point as anchor relative.
         *
         * @param nodePoint A given coordinate.
         ...
         * @return A point in world space coordinates.
         */
        MATH::Vector2f convertTouchToNodeSpace(Touch * touch) const;
         ...
         * @return A point in world space coordinates, anchor relative.
         */
        MATH::Vector2f convertTouchToNodeSpaceAR(Touch * touch) const;
    ...
    protected:
        ...
        MATH::Quaternion _rotationQuat;      ///rotation using quaternion, if _rotationZ_X == _rotationZ_Y, _rotationQuat = RotationZ_X * RotationY * RotationX, else _rotationQuat = RotationY * RotationX

        float _scaleX;                  ///< scaling factor on x-axis
        float _scaleY;                  ///< scaling factor on y-axis
        float _scaleZ;                  ///< scaling factor on z-axis

        MATH::Vector2f _position;                ///< position of the node
        ...
        mutable MATH::Matrix4 _transform;      ///< transform
        mutable bool _transformDirty;   ///< transform dirty flag
        mutable MATH::Matrix4 _inverse;        ///< inverse transform
        mutable bool _inverseDirty;     ///< inverse transform dirty flag
        mutable MATH::Matrix4 _additionalTransform; ///< transform
        ...
        HObject *_userObject;               ///< A user assigned Object
        ...
        bool _ignoreAnchorPointForPosition; ///< true if the Anchor MATH::Vector2f will be (0,0) when you position the Node, false otherwise.
     ...
     * @parma p         Point to a MATH::Vector3f for store the intersect point, if don't need them set to nullptr.
